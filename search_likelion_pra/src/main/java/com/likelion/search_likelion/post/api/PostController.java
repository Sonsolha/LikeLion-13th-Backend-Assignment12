...
import com.likelion.search_likelion.post.api.dto.request.PostSaveRequestDto;
import com.likelion.search_likelion.post.api.dto.response.PostInfoResponseDto;
...
public class PostController {
    ...
    public ResponseEntity<Response<Long>> postSave(@RequestBody PostSaveRequestDto postSaveRequestDto) {
